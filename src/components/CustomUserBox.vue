<template>
    <div class="kiwi-userbox">
        ...
        <div class="kiwi-userbox-basicinfo">
            ...
            <div v-if="asl.a">
                <span class="kiwi-userbox-basicinfo-title">Età</span>
                <span class="kiwi-userbox-basicinfo-data">{{asl.a}}</span>
            </div>
            <div v-if="asl.s">
                <span class="kiwi-userbox-basicinfo-title">Sesso</span>
                <span class="kiwi-userbox-basicinfo-data">{{asl.s}}</span>
            </div>
            <div v-if="asl.l">
                <span class="kiwi-userbox-basicinfo-title">Località</span>
...
export default {
    ...
    methods: {
        ...
        createBanMask: function banMask() {
            let reason = this.$state.setting('buffers.default_ban_mask');
        ...
        kickbanUser: function kickbanuser() {
            ...
            let banMask = this.createBanMask();
            let reason = state.setting('buffers.default_ban_mask');
            this.network.ircClient.raw('MODE', this.buffer.name, '+b', banMask);
            this.network.ircClient.raw('KICK', this.buffer.name, this.user.nick, reason);
        },
    },
